...
WHAT IT ACTUALLY COVERS - 1 of 5 training cohorts. Only UPMC ships a real confidence (kNN.prob,
51 distinct values spanning 0.14 to 1.0). CRC, Keren, Phillips and Sorin all report a constant
1.0, where confidence weighting is exactly equal to plain cross-entropy. Gate 6 reports this as a
UPMC-fold diagnostic and never as a roster-wide effect.
"""
import os, sys
import numpy as np
import pandas as pd
